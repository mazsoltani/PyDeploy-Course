    ...
    <body>
     <div class="container mt-5">
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <form action="<?php echo e(route('fruit')); ?>" method="POST" class="mb-4">
                    <?php echo csrf_field(); ?>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <form action="<?php echo e(route('number')); ?>" method="POST" class="mb-4">
                    <?php echo csrf_field(); ?>
                    <div class="form-group">
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <form action="<?php echo e(route('quran')); ?>" method="GET" class="mb-4">
                    <?php echo csrf_field(); ?>
        ...
        <?php if(isset($fruitData)): ?>
        <div class="mt-5">
            <h2 class="text-center">Results for <?php echo e($fruit); ?></h2>
            <?php echo e(dd($fruitData)); ?>

        <?php endif; ?>


        <?php if(isset($numberData)): ?>
            <div class="mt-5">
            <h2 class="text-center">Results for <?php echo e($number); ?></h2>
            <?php echo e(dd($numberData)); ?>

        <?php endif; ?>

        <?php if(isset($quranData)): ?>
        <div class="mt-5">
        <h2 class="text-center">list of Surahs in the Quran</h2>
        <?php echo e(dd($quranData)); ?>
...
<?php /**PATH /Users/taherechegini/Documents/Projects/Sajjad Aemmi/weather 2/resources/views/api.blade.php ENDPATH**/ ?>